            ...
            <div className="userlist">
                ...
                <Table
                    ...
                    <Column
                        ...
                        render={(text, record) => (
                            <span>
                                <Button type="primary" onClick={this.editUser.bind(this, record.id)}>编辑</Button>&nbsp;&nbsp;
                ...
                <Modal
                    ...
                    <div className="addtabel" style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                        <table cellpadding="5">
                            <tr>
